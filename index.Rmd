...
<center>
![FigName](compare_rcp6p0.jpg)
</center>

## Climate Hotspots: A Sustainability Index for Agricultural Production

For each RCP we offer maps for absolute and relative changes.
Regardless of the RCP, the maps cover only one future time period, 2070-2100.
Read more on the creation of the data in the [About](http://economic-development-ml.iae-csic.org/index_may23.html) section. 
